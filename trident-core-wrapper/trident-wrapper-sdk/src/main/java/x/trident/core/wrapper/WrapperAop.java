...
package x.trident.core.wrapper;
...
import x.trident.core.wrapper.api.exception.WrapperException;
import x.trident.core.wrapper.api.exception.enums.WrapperExceptionEnum;
...
public class WrapperAop {
     ...
     * 切入点
     */
    @Pointcut("@annotation(x.trident.core.wrapper.api.annotation.Wrapper)")
