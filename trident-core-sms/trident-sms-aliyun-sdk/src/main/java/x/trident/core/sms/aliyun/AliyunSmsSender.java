...
package x.trident.core.sms.aliyun;
...
import x.trident.core.sms.aliyun.enums.AliyunSmsResultEnum;
import x.trident.core.sms.aliyun.msign.MultiSignManager;
import x.trident.core.sms.api.SmsSenderApi;
import x.trident.core.sms.api.exception.SmsException;
import x.trident.core.sms.api.exception.enums.SmsExceptionEnum;
import x.trident.core.sms.api.pojo.AliyunSmsProperties;

import java.util.Map;

import static x.trident.core.sms.api.exception.enums.SmsExceptionEnum.SEND_SMS_PARAM_NULL;
